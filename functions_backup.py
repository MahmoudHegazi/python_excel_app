...
def returnSheetForGivinId(sheetid, requestOffset, perPage, page):
    ...
    try:
        selectTableString = "SELECT * FROM %s ORDER BY id OFFSET %s LIMIT %s;"%(tableName, requestOffset, perPage)
